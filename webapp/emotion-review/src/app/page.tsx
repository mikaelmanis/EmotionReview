...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] justify-items-center pad-20 min-h-screen sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <p className="text-lg sm:text-xl text-center sm:text-left max-w-[600px] font-medium text-foreground/70">
          This is a simple app that can predict your emotions on a text you provide
        </p>
        ...
        <EmotionForm />
        <footer className="flex flex-row gap-13 justify-content-bottom sm:items-start text-sm sm:text-base text-foreground/70">
      <Link
